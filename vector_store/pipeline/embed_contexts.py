...
Vector dimensions and chunk settings are read from ChatbotConfig (DB)
at import time via vector_store.pipeline.config.
"""
...
from vector_store.pipeline.config import (
    CHUNK_OVERLAP,
    CHUNK_SIZE,
    DOCUMENT_SOURCE_TAG,
...
# Map LLM section keys → SectionType enum values
SECTION_TYPE_MAP = {
